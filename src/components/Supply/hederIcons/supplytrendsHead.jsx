...
const SHeaderIcon = ({ onDateOptionChange }) => {
      ...
      {isSidebarOpen && (
        <div className="sidebar" style={styles.sidebar}>
          ...
          <div className="sidebar-content" style={styles.sidebarContent}>
            <h3>Info Sidebar</h3>
            <p>This chart provides a comprehensive view of energy supply trends from various sources, such as renewable and non-renewable energy, over a specified period. By visualizing how supply fluctuates daily, weekly, or monthly, the chart helps stakeholders understand key patterns in energy production and availability. Monitoring supply trends enables better resource planning, helps prevent shortages, and supports the integration of renewable sources into the energy mix, ensuring a stable and efficient grid operation.</p>
          </div>
        </div>
      )}
    </div>
