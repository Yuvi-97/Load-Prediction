...
const CHeaderIcon = ({ onDateOptionChange }) => {
      ...
      {isSidebarOpen && (
        <div className="sidebar" style={styles.sidebar}>
          ...
          <div className="sidebar-content" style={styles.sidebarContent}>
            <h3>Info Sidebar</h3>
            <p>This chart illustrates how energy production fluctuates throughout the day from various sources. It highlights peak production periods, typically during the middle of the day when solar generation is at its highest, and tracks how other energy sources, such as wind and batteries, contribute at different times. By analyzing this trend, operators can better understand the balance between supply and demand, optimize the use of renewable energy sources, and ensure grid stability.</p>
          </div>
        </div>
      )}
    </div>
